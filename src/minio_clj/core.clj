...
(defn connect
  ([]
   (connect "https://play.minio.io:9000" "Q3AM3UQ867SPQQA43P2F", "zuf+tfteSlswRu7BJ86wekitnifILbZam1KYY3TG"))
...
(defn get-object
  "Takes connection and a map of [bucket name] keys as returned by (put-object)
